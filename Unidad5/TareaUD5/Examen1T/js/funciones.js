...
function jsonObject(dni, nombre, apellidos, direccion, email, telefono, fechaAlta, fechaNac, provincia, age, deporte, sexo) {
    const json = {
    dni: dni.value,
    nombre: nombre.value,
    ...
    provincia: provincia.options[provincia.selectedIndex].value, //Podemos cambiarlo a text si queremos
    age: parseInt(age.value),
    deporte: deporte.options[deporte.selectedIndex].value, //Podemos cambiarlo a text si queremos
    email: email.value,
    fechaNac: fechaNac.value,
    fechaAlta: fechaAlta.value,
    sexo: getValueRadio(sexo),
